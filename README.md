...
This app is easy to deplay because it is only a client sided app with no backend on it, mine is actually deployed here with https://pages.github.com/, here is a live example of the app https://link04.github.io/tic-tac-toe-project/
